...
class Database
{
     ...
     */
    function call_sp($procName, $params="")
    {
        ...
        $sqlSuccess = $this->mysql->multi_query($sql);
        ...
        if($sqlSuccess)
        {
            if($this->mysql->more_results())
            {
                ...
                {
                    $extraResult = $this->mysql->use_result();
        ...
        {
            throw new Exception("The call failed: " . $this->mysql->error);
        }
    }
